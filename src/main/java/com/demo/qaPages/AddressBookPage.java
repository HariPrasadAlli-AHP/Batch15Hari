...
public class AddressBookPage {
	...
	public void enterDetails() throws Exception {
		...
		driver.findElement(telePhone).sendKeys("Demo");
		
		Thread.sleep(1000);
		driver.findElement(address).click();
		driver.findElement(address).sendKeys("Demo");
		
		Thread.sleep(1000);
		driver.findElement(city).click();
		Thread.sleep(1000);
		driver.findElement(city).sendKeys("Demo");
		...
		driver.findElement(postCode).sendKeys("Demo");
		Thread.sleep(1000);
